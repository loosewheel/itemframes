...
local remove_item = function(pos, node)
	local objs = nil
	if node.name == "itemframes:frame" or node.name == "itemframes:small_frame" then
...
minetest.register_node("itemframes:small_frame",{
	description = S("Small item frame"),
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
	...
	tiles = {"itemframes_small_frame.png"},
	inventory_image = "itemframes_small_frame_wield.png",
	wield_image = "itemframes_small_frame_wield.png",
	paramtype = "light",
	paramtype2 = "facedir",
	sunlight_propagates = true,
	groups = {choppy = 2, dig_immediate = 2},
...
minetest.register_lbm({
	...
	nodenames = {"itemframes:frame", "itemframes:small_frame", "itemframes:pedestal"},
...
if minetest.get_modpath("mesecons_mvps") then
	...
	mesecon.register_mvps_stopper("itemframes:small_frame")
